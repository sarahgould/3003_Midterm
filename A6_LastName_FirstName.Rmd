...
We want to make boxplots correltating sex and performance on math, reading, and writing exams. We also want to create a boxplot to associate the status of lunch (whether free or reduced) to exam scores. We could additionally make conditioning plots to see if there is any evidence of Simpson's Paradox in terms of the correlation between the parents' level of education and the result of student exams. Additionally, we can create scatterplots comparing two types of exams, such as math and reading, to see if students who achieve well in oen subject also do well in another. 
