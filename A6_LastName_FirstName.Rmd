...
Link: https://degree.lamar.edu/articles/undergraduate/parents-education-level-and-childrens-success/
...
The dataset contains attributes including gender, race, parent education level, test preparation, and their eligibility to get free/reduced lunch at school.
Then the results are encapsulated in their reading, writing, and math scores. This data ties into the article as who/what the parents are can impact
their children's academic levels and/or success. The descriptions of all the variables are in the info section on the kaggle page.
